...
<ul>
<li style="background-color: transparent;">짝수 인덱스에서는 <code>arr</code>에서 <code>query[i]</code>번 인덱스를 제외하고 배열의 <code>query[i]</code>번 인덱스 뒷부분을 잘라서 버립니다.</li>
...
<th>result</th>
        ...
        <tbody><tr>
<td style="background-color: transparent;">[0, 1, 2, 3, 4, 5]</td>
<td style="background-color: transparent;">[4, 1, 2]</td>
<td>[1, 2, 3]</td>
</tr>
</tbody>
      </table>
