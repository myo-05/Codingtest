...
2025년 03월 15일 03:08:33

### 문제 설명

<p style="background-color: transparent;">n × n 크기의 이차원 배열 <code>arr</code>이 매개변수로 주어질 때, <code>arr</code>이 다음을 만족하면 1을 아니라면 0을 return 하는 solution 함수를 작성해 주세요.</p>

<ul>
<li>0 ≤ i, j &lt; n인 정수 i, j에 대하여 <code style="background-color: transparent;">arr[i][j]</code> = <code>arr[j][i]</code></li>
</ul>
